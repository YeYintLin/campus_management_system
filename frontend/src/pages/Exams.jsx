...
const initialExams = [
    ...
    { id: 'EX004', course: 'ENG105', title: 'Essay Submission', date: '2026-03-20', time: '23:59', duration: 'N/A', room: 'Online', status: 'Published', year: '1st Year' },
];
...
const Exams = () => {
    ...
    const handleSave = (e) => {
        e.preventDefault();
        if (currentExam) {
            setExams(exams.map(ex => ex.id === currentExam.id ? { ...formData, id: currentExam.id } : ex));
        } else {
            const newExam = { ...formData, id: `EX${Date.now()}` };
        ...
        <div className="exams-page animate-fade-in">
            ...
            <div className="exams-grid">
                {filteredExams.map(exam => (
                    <div key={exam.id} className="exam-card glass-panel hover-glow">
                        <div className="exam-card-header">
                            ...
                            <div className="exam-actions">
                                ...
                                <button className="icon-btn delete" onClick={() => handleDelete(exam.id)} title="Delete">
                                    <Trash2 size={16} />
                                </button>
                            </div>
                        </div>
