...
async function runAttendanceTests() {
    ...
    try {
        ...
        const cellA1 = sheetV.getCell('A1').value;
        console.log('A1 Title Header Value in Excel:', cellA1);
        ...
        assert.ok(typeof formulaW6 === 'object' && formulaW6.formula && formulaW6.formula.includes('COUNTIF'), 'W6 cell MUST contain live COUNTIF formula');
